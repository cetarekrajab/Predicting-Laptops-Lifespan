...
X = df.drop(columns=["reported_age_years_avg", "release_year"])
...
joblib.dump(best_model, "best_model_without_year.pkl")
joblib.dump(scaler, "scaler_without_year.pkl")

print("Best model saved as 'best_model_without_year.pkl'")
print("Scaler saved as 'scaler_without_year.pkl'")
